...
class TransactionTest(unittest.TestCase):
    ...
    def test_transaction_output(self):
        ...
        self.assertEqual(block_util.decipher_script(tx_output.pubkey_script), [
                         'OP_HASH160', 'OP_PUSHBYTES_20', '8ce773d254dc5df886b95848880e0b40f1056432', 'OP_EQUAL'])
    ...
    def test_transaction_witness(self):
        ...
        self.assertEqual(tx_witness.items_deciphered, [['OP_PUSHBYTES_48', '440220537f470c1a18dc1a9d233c0b6af1d2ce18a07f3b244e4d9d54e0e60c34c55e67022058169cd11ac42374cda217', 'OP_RETURN_214', 'OP_RETURN_226',
                         'OP_RIGHT', 'OP_PUSHBYTES_67', 'abd0e79549f7b84acc6542817466dc9b3001'], ['OP_PUSHBYTES_3', '01c176', 'OP_1ADD', 'OP_PUSHBYTES_72', '843933bd7f0e8782716e8439fc44723d3745feefde2d57b761f503']])
