...
parser.add_argument('-m', '--include_mempool', help='Flag to include pre-validated transactions. Default value is False')
parser.add_argument('-n', '--num_workers', help='Number of parallel workers ot parse the blockchain. Defualt value is 16')
...
blockchain_parser = BlockchainParser(blockchain_dir, blk_file_start, blk_file_end, include_mempool, num_workers)
